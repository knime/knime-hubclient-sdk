...
import org.knime.hub.client.sdk.ent.catalog.SpaceRequestBody;
...
public final class CatalogServiceClient {
     ...
     * @param requestBody The request body (required)
     * @param additionalHeaders Map of additional headers
     * @return {@link ApiResponse}
     *
     * @throws HubFailureIOException if an I/O error occurred
     * @since 1.3
     */
    public ApiResponse<ItemUploadInstructions> initiateUploadById(final String id, final ItemUploadRequest requestBody,
        final Map<String, String> additionalHeaders) throws HubFailureIOException {
        LOGGER.atDebug() //
            .addArgument(() -> id) //
            .log("Initiating upload for item with ID {}");
     ...
     * @since 1.3
     */
    public @Owning AsyncHubUploadStream createAsyncHubUploadStreamById(final String itemId, final String itemName,
        final boolean isWorkflowLike, final EntityTag itemETag, final Map<String, String> additionalHeaders)
        throws HubFailureIOException {
        return AsyncHubUploadStream.createById(this, additionalHeaders, itemId, itemName, isWorkflowLike, itemETag, -1);
    }
