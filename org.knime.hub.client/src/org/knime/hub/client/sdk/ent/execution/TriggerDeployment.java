...
public final class TriggerDeployment extends Deployment {
    ...
    static final String TYPE = "trigger";

    @JsonCreator
    private TriggerDeployment(@JsonProperty(value = JSON_PROPERTY_ID, required = true) final String id,
