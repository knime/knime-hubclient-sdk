...
/**
 * POJO representing a KNIME Hub data-app deployment.
 *
 * @author Magnus Gohm, KNIME AG, Konstanz, Germany
 * @since 0.2
 */
@JsonIgnoreProperties(ignoreUnknown = true)
public final class DataAppDeployment extends Deployment {

    static final String TYPE = "data-app";

    @JsonCreator
    private DataAppDeployment(@JsonProperty(value = JSON_PROPERTY_ID, required = true) final String id,
    ...
    public DeploymentType getType() {
        return DeploymentType.DATA_APP;
    }
