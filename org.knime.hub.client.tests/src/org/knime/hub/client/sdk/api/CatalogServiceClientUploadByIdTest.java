...
/**
 * Tests for {@link CatalogServiceClient#prepareUploadById(String, ItemUploadRequest, Map)}.
 */
class CatalogServiceClientUploadByIdTest extends AbstractTest {
    ...
    @Test
    void testPrepareUploadById() throws IOException {
        ...
        final ApiResponse<ItemUploadInstructions> response = CATALOG_CLIENT.prepareUploadById(
